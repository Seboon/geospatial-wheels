...
[release](https://github.com/cgohlke/geospatial-wheels/releases/tag/v2026.2.26):
...
- [GDAL](https://pypi.org/project/GDAL/) 3.12.2
...
- [boost](https://archives.boost.io/release/1.90.0/source/boost_1_90_0.zip) 1.90.0
- [brotli](https://github.com/google/brotli) 1.2.0
- [bzip2](https://sourceware.org/pub/bzip2/bzip2-1.0.8.tar.gz) 1.0.8
- [c-ares](https://github.com/c-ares/c-ares/releases/download/v1.34.6/c-ares-1.34.6.tar.gz) 1.34.6
- [c-blosc2](https://github.com/Blosc/c-blosc2) 2.23.0
...
- [curl](https://curl.se/download/curl-8.17.0.tar.gz) 8.17.0
- [dav1d](https://github.com/videolan/dav1d) 1.5.3
- [expat](https://github.com/libexpat/libexpat/releases/download/R_2_7_4/expat-2.7.4.tar.gz) 2.7.4
- [freexl](https://www.gaia-gis.it/gaia-sins/freexl-2.0.0.tar.gz) 2.0.0
- [gdal](https://github.com/OSGeo/gdal) 3.12.2
- [geos](https://download.osgeo.org/geos/geos-3.14.1.tar.bz2) 3.14.1+lgpl
...
- [libaec](https://gitlab.dkrz.de/k202009/libaec) 1.1.5
...
- [libpng](https://github.com/glennrp/libpng) 1.6.55
...
- [littlecms](https://github.com/mm2/Little-CMS) 2.18
- [lz4](https://github.com/lz4/lz4) 1.10.0
- [lzma](https://github.com/tukaani-project/xz) 5.8.2
- [minizip-ng](https://github.com/zlib-ng/minizip-ng) 4.1.0
- [netcdf-c](https://github.com/Unidata/netcdf-c) 4.9.3
- [nghttp2](https://github.com/nghttp2/nghttp2) 1.68.0
- [openexr](https://github.com/AcademySoftwareFoundation/openexr) 3.4.5
- [openjpeg](https://github.com/uclouvain/openjpeg) 2.5.4
- [openjph](https://github.com/aous72/OpenJPH) 0.26.3
- [openssl](https://github.com/openssl/openssl) 3.0.19
- [pcre2](https://github.com/PCRE2Project/pcre2.git) 10.47
- [postgresql](https://ftp.postgresql.org/pub/source/v17.4/postgresql-17.4.tar.gz) 17.4
- [proj](https://download.osgeo.org/proj/proj-9.7.1.tar.gz) 9.7.1
...
- [sqlite](https://github.com/sqlite/sqlite) 3.51.1
...
- [Rust](https://www.rust-lang.org/tools/install) 1.93.1
- [CPython](https://www.python.org/downloads/windows/) 3.12, 3.13, 3.14, 3.14t (win32, win-amd64, win-arm64)
